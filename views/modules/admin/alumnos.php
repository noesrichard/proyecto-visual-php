...
<div id="toolbar">
    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="newUser()">Nuevo Alumno</a>
    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="editUser()">Editar Alumno</a>
    ...
    function destroyUser() {
        ...
        if (row) {
            $.messager.confirm('Confirm', 'Are you sure you want to destroy this user?', function(r) {
                if (r) {
                    $.post('eliminar.php?entidad=alumno&cedula='+row.cedula, {
                        id: row.id
                    }, function() {
                        $('#dg').datagrid('reload'); // reload the user data
                    }, 'json');
